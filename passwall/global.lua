...
local CHECK_IP_URL = luci.dispatcher.build_url("admin", "services", appname, "ip")

-- Tambah satu elemen dummy HTML untuk merender template status_bottom
local status_s = m:section(SimpleSection, nil, nil)
status_s.template  = 'passwall/global/status_bottom'

-- Suntik pemboleh ubah JavaScript yang diperlukan oleh status_bottom.htm
status_s.description = string.format(
    '<script type="text/javascript">var CHECK_IP_URL = "%s";</script>',
    CHECK_IP_URL
)
